...
async def main():
    """Test WebSocket connection using SigV4 pre-signed URL"""
    ...
    try:
        async with websockets.connect(sigv4_url, ssl=ssl_context) as ws:
            print("="*80)
            print("Testing WebSocket Agent with Pre-signed URL")
            print("="*80)
